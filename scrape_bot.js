...
// --- CONFIGURATION ---
const TARGET_URL = 'https://jinjae1029-gif.github.io/stock-bot-1/';
const TARGET_BOT_ID = 'stock-bot-1';
...
(async () => {
    console.log("🚀 Starting Scraper Bot (Bot 1)...");
    ...
    try {
        ...
        let cleanText = rawText
            .replace('주문표 (Order Sheet)', '📅 <b>주문표 (Bot 1 Scraped)</b>')
            .replace('닫기', '')
            .replace('텍스트 복사', '')
            .trim();
